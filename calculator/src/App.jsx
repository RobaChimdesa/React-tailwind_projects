  ...
  return (
    <div className="calculator">
      ...
      <div className="buttons">
        <button className="opperator" onClick={clear}>AC</button>
        <button className="opperator" onClick={deleteEl}>DE</button>
       
        <button id='.' className="opperator" onClick={handleClick}>.</button>
        <button id='/' className="opperator" onClick={handleClick}>/</button>
        ...
        <button className="opperator col-span-2" onClick={calculate}>=</button>
